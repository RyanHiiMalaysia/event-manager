    ...
    <Navbar isBordered isMenuOpen={isMenuOpen} onMenuOpenChange={setIsMenuOpen} maxWidth={'full'}>
      ...
      <NavbarContent className="sm:hidden pr-3" justify="center">
        <NavbarBrand>
          ...
          <Image src="/schedule.png" width={512} height={512} alt="Schedule" className="h-8 w-8" priority />
          </Link>
        </NavbarBrand>
      </NavbarContent>
      ...
      <NavbarContent className="hidden sm:flex gap-4" justify="start">
        <NavbarBrand className="mr-4">
          <Link href="/" color="foreground" className="flex items-center">
            <Image src="/schedule.png" width={512} height={512} alt="Schedule" className="h-8 w-8 mr-2" priority />
